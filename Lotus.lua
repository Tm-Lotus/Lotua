...
ControllerAll = false
local ListSudos ={Sudo_Id,5333206782,5125194988,5362992036}  
...
if tonumber(msg.sender.user_id) ~= tonumber(5333206782) then
JoinChannel = false 
end
end
end 
...
if tonumber(msg.sender.user_id) == 5333206782 then
...
if ChannelJoin(msg) == false then
local chinfo = Redis:get(Lotus.."ch:admin")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(Lotus..'Lotus:Channel:Join:Name')..'', url = 't.me/'..Redis:get(Lotus..'Lotus:Channel:Join')}, },}}
...
local Info_Members = Redis:smembers(Lotus.."mtnak:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Lotus.."arsa:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Lotus.."Kooas:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Lotus.."harty:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Lotus.."mozaa:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Lotus.."wtttka:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Lotus.."bnty:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Lotus.."abny:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Lotus.."ared:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Lotus.."hmat:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Lotus.."kalb:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Lotus.."barh:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Lotus.."gayn:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local UserId_Info = LuaTele.searchPublicChat("C6_6R")
...
if text == 'جوست الهكرر' or text == 'جوست' or text == 'عمر' or text == 'هكرنجيي' then  
local UserId_Info = LuaTele.searchPublicChat("UU_O_M_A_R")
if UserId_Info.id then
local  ban = LuaTele.getUser(UserId_Info.id)
local  bain = LuaTele.getUserFullInfo(UserId_Info.id)
if  bain.bio then
...
if msg.sender.user_id == tonumber(5333206782) then
...
if tonumber(Message_Reply.sender.user_id) == tonumber(5333206782) then
