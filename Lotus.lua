...
if text == "مارك" or text == "بلح مارك" then
local m = "http://t.me/PvNova/555"
local Mohamed = LuaTele.getUser(Sudo_Id) 
local ban = LuaTele.getUser(msg.sender.user_id)
if ban.first_name then
Mohamediusername = '*◍ مرحبا بك يا* '..ban.first_name..' \n◍ انت الان في اوامر لعبه البنك  '
else
Mohamediusername = " لا يوجد"
end
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'قناه السورس', url = "http://t.me/TmNova"}
},
}
local rep = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id="..msg_chat_id.."&caption="..URL.escape(Mohamediusername).."&photo="..m.."&reply_to_message_id="..rep.."&parse_mode=Markdown&reply_markup="..JSON.encode(keyboard))
end
